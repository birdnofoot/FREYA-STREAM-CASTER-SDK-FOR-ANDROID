...
拥有极强的性能与兼容性，是目前唯一支持全平台的软编推流SDK。针对ARM、ARMV7-A、ARM64-V8A、X86、X86_64、MIPS、MIPS64全平台极致优化。让低端手机也可以流畅地进行高清推流。
</br>
联动项目：[FREYA LIVE LIBRARY OPTIMIZER FOR ANDROID](https://github.com/jkkj93/FREYA-LIVE-LIBRARY-OPTIMIZER-FOR-ANDROID)
</br>
RTMP直播推流常用库的编译简化/优化工具
</br>
</br>
![image](https://github.com/jkkj93/FREYA-STREAM-CASTER-SDK-FOR-ANDROID/raw/master/screenshots/main.jpg)
![image](https://github.com/jkkj93/FREYA-STREAM-CASTER-SDK-FOR-ANDROID/raw/master/screenshots/push_portrait.jpg)
![image](https://github.com/jkkj93/FREYA-STREAM-CASTER-SDK-FOR-ANDROID/raw/master/screenshots/push_landscape.jpg)
</br>
</br>
一、系统要求
</br>
...
支持ARM、ARMV7-A、ARM64-V8A、X86、X86_64、MIPS、MIPS64全平台，并针对这些平台进行了极致优化
</br>
</br>
三、软件功能
</br>
...
6.在网络正常且带宽足够的情况下，如果画面出现马赛克，或延迟较高(一般延迟在1-2S左右)，则说明CPU占用率过高。降低帧率(FPS)、分辨率的值可明显改善此现象。低端设备不建议设置太高的帧率
</br>
</br>
7.音频采样率推荐使用兼容性最好的44100HZ，部分移动设备不支持44100HZ外的其他采样率
</br>
</br>
七、其他事项
</br>
